...
var MediaRenderer = ({
  ...
  if (!isLoaded) {
    return /* @__PURE__ */ jsx("div", { className: slider_default.placeholder, "aria-hidden": "true" });
  }
  switch (media.type) {
    case "image":
      if (renderImage) {
...
var SlideComponent = ({
  ...
  if (React.isValidElement(item)) {
    ...
    content = /* @__PURE__ */ jsx("div", { children: String(item) });
  }
  return /* @__PURE__ */ jsx(
    "div",
    {
...
function SliderInner(props, ref) {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      ...sliderAriaAttrs,
      children: [
        /* @__PURE__ */ jsx("div", { className: slider_default.sliderViewport, children: /* @__PURE__ */ jsx("div", { ref: trackRef, className: trackClasses, children: slideItems.map((item, index) => /* @__PURE__ */ jsx(
          SlideComponent,
          {
            item,
            index,
        ...
        showArrows && arrowsEnabled && !isMarquee && /* @__PURE__ */ jsxs(Fragment, { children: [
          renderArrow ? renderArrow("prev", prevSlide, !canGoPrev) : /* @__PURE__ */ jsx(
            "button",
            {
              type: "button",
              ...
              children: mergedOptions.arrows?.icons?.prev ?? /* @__PURE__ */ jsx(ChevronLeftIcon, {})
            }
          ),
          renderArrow ? renderArrow("next", nextSlide, !canGoNext) : /* @__PURE__ */ jsx(
            "button",
            {
              type: "button",
              ...
              children: mergedOptions.arrows?.icons?.next ?? /* @__PURE__ */ jsx(ChevronRightIcon, {})
            }
          )
        ] }),
        showDots && dotsEnabled && !isMarquee && /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: Array.from({ length: maxSlide + 1 }).map((_, index) => {
              ...
              if (renderDot) {
                return /* @__PURE__ */ jsx(React.Fragment, { children: renderDot(index, isActive, () => goToSlide(index)) }, index);
              }
              return /* @__PURE__ */ jsx(
                "button",
                {
        ...
        a11yOptions?.enabled && a11yOptions?.liveRegion && /* @__PURE__ */ jsxs(
          "div",
          {
...
var Slider = forwardRef(SliderInner);
